...
st.set_page_config(page_title="SEA EXPLORATION", layout="wide")
...
st.markdown(
    "<div class='big-font'>SEA EXPLORATION</div>",
    unsafe_allow_html=True
)
k1, k2, k3 = st.columns([1.5,5,1])
with k2:
    st.image('img\sea.jpg', width=1000)
...
html_code = """
<elevenlabs-convai agent-id="XLLK70KYu6Z9wSp1ugay"></elevenlabs-convai>
