...
st.set_page_config(page_title="JUNGLE EXPLORATION", layout="wide")
...
st.markdown(
    "<div class='big-font'>JUNGLE EXPLORATION</div>",
    unsafe_allow_html=True
)
k1, k2, k3 = st.columns([1.5,5,1])
with k2:
    st.image('img\jungle.jpg', width=1000)
...
html_code = """
<elevenlabs-convai agent-id="fYcBSwtxHKKBrgYNAaEx"></elevenlabs-convai>
...
g1, g2, g3 = st.columns([10,3,10])
with g2:
    x = st.button("Get Conversation Transcript")
if x:
    client = ElevenLabs(
